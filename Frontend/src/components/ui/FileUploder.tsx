        ...
        <div className="mt-6 w-86 h-30 bg-gray-3 p-2 rounded-lg flex items-center justify-center">
           ...
           onDragLeave={handleDragLeave}
            onDrop={handleDrop} className={`w-[98%] h-[97%] border-2 p-2 flex flex-col gap-3 items-center justify-center box-border border-dashed rounded-lg cursor-pointer transition-transform duration-250 group ${isDragging ? "border-blue-10 bg-blue-3/40 scale-[1.01]" : "border-gray-7"}`}>
                <div>
                    <Upload className="stroke-blue-11 transition-transform duration-250 group-hover:-translate-y-[1.5px] " />
                </div>
                <div className="text-[.8rem] text-gray-12 text-center font-medium"><strong className="text-blue-11">Click</strong> or <strong className="text-blue-11">drop</strong> your PDF, DOC, or DOCX file here to get an instant resume score.</div>
                <input
                    type="file"
                    ref={fileUploadRef}
                    className="hidden"
