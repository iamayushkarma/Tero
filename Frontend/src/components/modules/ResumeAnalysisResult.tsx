...
function ResumeAnalysisResult() {
  ...
  function getScoreColor(score: number, isDark: boolean) {
    if (score < 40) return isDark ? "#f87171" : "#dc2626";
    if (score < 50) return isDark ? "#fb923c" : "#ea580c";
    if (score < 75) return isDark ? "#fde047" : "#facc15";
    if (score < 90) return isDark ? "#4ade80" : "#22c55e";
  ...
  return (
    <section className="bg-gray-3 dark:bg-gray-12/50 min-h-screen w-full p-5 pt-20 md:mx-auto">
      <motion.div
        className="mx-auto grid w-full items-start gap-5 md:w-11/12 md:grid-cols-10 md:p-8"
        initial="hidden"
        animate="visible"
        variants={containerVariants}
      >
        {/* score section */}
        <motion.div className="md:sticky md:top-[20%] md:col-span-3" variants={itemVariants}>
          <div className="bg-bg-gray-1 dark:bg-gray-12/5 border-gray-5 dark:border-gray-11/40 flex flex-col items-center justify-center rounded-xl border py-2 md:w-[95%]">
            ...
            <div className="border-b-gray-4 dark:border-b-gray-11/50 box-border w-11/12 border-b p-5 text-center md:p-8">
              ...
              <motion.div
                style={{ color }}
                className="mt-2 text-[1.3rem] font-semibold md:text-[1.5rem]"
        ...
        {/* review section */}
        <motion.div
          className="sm:bg-blue-5/50 sm:border-gray-5 sm:dark:border-gray-11/40 sm:dark:bg-blue-12/20 text-gray-12/90 dark:text-gray-4 mt-5 box-border w-full rounded-xl font-medium sm:border md:col-span-7 md:mt-0 md:p-8"
          variants={itemVariants}
        >
          <motion.div
            className="border-gray-3 dark:bg-gray-12/90 bg-bg-gray-2 overflow-hidden rounded-xl border dark:border-gray-800"
            ...
            <div className="border-b border-gray-200 px-6 py-5 dark:border-gray-800">
              <div className="flex items-start justify-between">
                ...
                {analysis?.atsResult?.parseRate && (
                  <motion.div
                    className="flex items-center gap-2 rounded-lg border border-green-200 bg-green-50 px-3 py-1.5 dark:border-green-800 dark:bg-green-900/20"
