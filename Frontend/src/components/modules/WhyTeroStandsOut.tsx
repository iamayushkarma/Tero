...
function WhyTeroStandsOut() {
  return (
    <div className="mt-30 p-4 md:p-10">
      {/* Heading */}
      ...
      <div className="mx-auto mt-10 grid w-[95%] gap-6 md:grid-cols-2 lg:grid-cols-3">
        <WhyTeroStandsOutCard
          absImg="/assets/resume-mistakes.svg"
          heading="Live content analysis"
          paragraph="See how your resume’s language matches industry standards. We’ll point out missing skills, certifications, and employer-preferred phrases - paste the job description to evaluate fit more precisely."
        />
        <WhyTeroStandsOutCard
          absImg="/assets/resume-number.svg"
          heading="ATS compatibility checks"
          paragraph="Spot formatting problems like unsupported fonts, tables, and headers that can affect ATS parsing. Receive simple, automated fixes."
        />
        <div className="md:col-span-2 md:mx-auto md:max-w-[50%] lg:col-span-1 lg:max-w-full">
          <WhyTeroStandsOutCard
            ...
            paragraph="Get guidance on the right section order, bullet style, and resume length. The checker spots issues and explains how to adjust your resume to match what recruiters look for, with fixes you can apply instantly."
          />
        </div>
      </div>
    </div>
  ...
  return (
    <div className="overflow-hidden rounded-lg p-4">
      ...
      <div className="bg-gray-3/50 dark:bg-gray-12/30 rounded-lg rounded-t-none px-8 py-6">
        <h3 className="lg:text-text-[1.4rem] dark:text-bg-blue-2 text-gray-12 mt-2 mb-4 font-semibold md:text-[1.2rem]">
          {heading}
        </h3>
