...
//         <h2 className="text-gray-12 dark:text-bg-gray-1 text-xl md:text-3xl lg:text-4xl">
...
function WhyTeroStandsOut() {
  return (
    ...
    >
      ...
      <motion.div
        variants={fadeUp}
        className="flex items-center justify-center p-2 text-center font-semibold"
      >
        <h2 className="text-gray-12 dark:text-bg-gray-1 text-xl md:text-3xl lg:text-4xl">
          A Practical Tool for Better Resume Analysis
        </h2>
      ...
      {/* Why Tero StandsOut Cards */}
      <motion.div
        variants={sectionStagger}
        className="mx-auto mt-10 grid w-[95%] gap-6 md:grid-cols-2 lg:grid-cols-3"
      >
        {whyTeroData.slice(0, 2).map((item, index) => (
          <WhyTeroStandsOutCard key={index} {...item} />
        ))}
